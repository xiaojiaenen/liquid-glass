  ...
  return (
    <GlassProvider defaultMode="dark">
      <div className="stage">
        ...
        {/* ───── 边框反光 BorderGlow ───── */}
        <Section title="边框反光 BorderGlow">
          <p style={{ margin: '0 0 16px', fontSize: 14, opacity: 0.6 }}>鼠标悬停查看边框反光效果，模拟真实玻璃边缘反光</p>
          <div className="row">
            <LiquidGlass borderGlow style={{ padding: '24px 32px' }}>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: 32, marginBottom: 8 }}>💎</div>
                <div style={{ fontSize: 16, fontWeight: 600 }}>默认反光</div>
            ...
            >
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: 32, marginBottom: 8 }}>🔮</div>
                <div style={{ fontSize: 16, fontWeight: 600 }}>柔和反光</div>
                <div style={{ fontSize: 13, opacity: 0.6, marginTop: 4 }}>低强度，窄宽度</div>
              </div>
            </LiquidGlass>
            <LiquidGlass
